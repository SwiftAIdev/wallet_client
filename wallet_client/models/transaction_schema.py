...
class TransactionSchema(BaseModel):
    ...
    data: Optional[TransactionSchemaData] = None
    __properties: ClassVar[List[str]] = ["id", "amount", "date", "category", "wallet_id", "status", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": TransactionSchemaData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
