...
class PaginationRequestTransactionSchemaRefill(BaseModel):
    """
    ...
    size: StrictInt
    total: StrictInt
    data: List[TransactionSchemaRefill]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "total": obj.get("total"),
            "data": [TransactionSchemaRefill.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
