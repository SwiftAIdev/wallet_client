...
class CompanyData(BaseModel):
    ...
    kpp: Optional[StrictStr] = ''
    address: Optional[StrictStr] = ''
    __properties: ClassVar[List[str]] = ["inn", "short_name", "full_name", "kpp", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "inn": obj.get("inn"),
            "short_name": obj.get("short_name") if obj.get("short_name") is not None else '',
            "full_name": obj.get("full_name") if obj.get("full_name") is not None else '',
            "kpp": obj.get("kpp") if obj.get("kpp") is not None else '',
