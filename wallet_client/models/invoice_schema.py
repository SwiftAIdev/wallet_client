...
class InvoiceSchema(BaseModel):
    ...
    phone_number: Optional[StrictStr] = 'RUB'
    __properties: ClassVar[List[str]] = ["id", "created_at", "updated_at", "is_delete", "inn", "email", "phone_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phone_number": obj.get("phone_number") if obj.get("phone_number") is not None else 'RUB'
        })
        return _obj
