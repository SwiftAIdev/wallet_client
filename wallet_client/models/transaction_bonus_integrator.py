...
class TransactionBonusIntegrator(BaseModel):
    """
    TransactionBonusIntegrator
    """ # noqa: E501
    id_user: Optional[StrictStr] = ''
    amount: Optional[Union[StrictFloat, StrictInt]] = 0
    __properties: ClassVar[List[str]] = ["id_user", "amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id_user": obj.get("id_user") if obj.get("id_user") is not None else '',
