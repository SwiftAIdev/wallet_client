...
class TestWalletSchema(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WalletSchema:
        """Test WalletSchema
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WalletSchema`
        """
        model = WalletSchema()
        if include_optional:
            return WalletSchema(
